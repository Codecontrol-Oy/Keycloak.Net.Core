...
public partial class KeycloakClient : IRealmsAdminClient
{
    public async Task<bool> ImportRealmAsync(string realm, Realm rep, CancellationToken cancellationToken = default)
    {
        var response = await _internalKeycloakClient.GetBaseUrl(realm).AppendPathSegment("/admin/realms")
    ...
    public async Task<IEnumerable<Realm>> GetRealmsAsync(string realm, CancellationToken cancellationToken = default)
    {
        return await _internalKeycloakClient.GetBaseUrl(realm).AppendPathSegment("/admin/realms")
    ...
    {
        return await _internalKeycloakClient.GetBaseUrl(realm).AppendPathSegment($"/admin/realms/{realm}")
    ...
    {
        var response = await _internalKeycloakClient.GetBaseUrl(realm).AppendPathSegment($"/admin/realms/{realm}")
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await _internalKeycloakClient.GetBaseUrl(realm).AppendPathSegment($"/admin/realms/{realm}/admin-events")
    ...
    public async Task<IEnumerable<ClientScope>>
        GetRealmDefaultClientScopesAsync(string realm, CancellationToken cancellationToken = default)
    {
        return await _internalKeycloakClient.GetBaseUrl(realm)
    ...
    public async Task<IEnumerable<Group>>
        GetRealmGroupHierarchyAsync(string realm, CancellationToken cancellationToken = default)
    {
        return await _internalKeycloakClient.GetBaseUrl(realm)
    ...
    public async Task<IEnumerable<ClientScope>>
        GetRealmOptionalClientScopesAsync(string realm, CancellationToken cancellationToken = default)
    {
        return await _internalKeycloakClient.GetBaseUrl(realm)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await _internalKeycloakClient.GetBaseUrl(realm).AppendPathSegment($"/admin/realms/{realm}/events")
            .SetQueryParams(queryParams)
    ...
    public async Task<Group>
        GetRealmGroupByPathAsync(string realm, string path, CancellationToken cancellationToken = default)
    {
        return await _internalKeycloakClient.GetBaseUrl(realm)
    ...
    public async Task<GlobalRequestResult>
        RemoveUserSessionsAsync(string realm, CancellationToken cancellationToken = default)
    {
        return await _internalKeycloakClient.GetBaseUrl(realm).AppendPathSegment($"/admin/realms/{realm}/logout-all")
            .PostAsync(new StringContent(""), cancellationToken)
            .HandleErrorsAsync()
    ...
    public async Task<Realm> RealmPartialExportAsync(string realm, bool? exportClients = null,
        bool? exportGroupsAndRoles = null, CancellationToken cancellationToken = default)
    {
        var queryParams = new Dictionary<string, object>
        {
    ...
    public async Task<GlobalRequestResult>
        PushRealmRevocationPolicyAsync(string realm, CancellationToken cancellationToken = default)
    {
        return await _internalKeycloakClient.GetBaseUrl(realm)
    ...
    public async Task<bool> TestLdapConnectionAsync(string realm, string action = null, string bindCredential = null,
        string bindDn = null,
